										...
										<div class="tab-content-inner active" data-content="signup">
											<h3>ADD Travel Package</h3>
												...
												<div class="row form-group">
													<div class="col-md-12">
													<form:form action="newpack" id="regform" method="post" modelAttribute="packages">
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" path="destination" name="destination"  placeholder="destination" class="form-control" >
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" id="pass1" path="no_of_seats" placeholder="Password" class="form-control" >
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label for="fee">Total fee</label>
														<input type="text" id="pass2"  placeholder="Total fee" class="form-control"  path="total_fee">
													</div>
												</div>

												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-block" id="savepak" name="save" value="Register" >
