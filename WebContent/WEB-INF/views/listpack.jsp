...
<table>
    ...
    <table border="1" cellpadding="5" class="styled-table">
        ...
        <c:forEach items="${listpack}" var="packs">
        <tr>
        
            <td>${packs.agency_name}</td>
            <td>${packs.district}</td>
            <td>${packs.destination}</td>
            <td>${packs.no_of_seat}</td>
            <td>${packs.total_fee}</td>
            <td>
             <a href="booking" mthod="post">book</a>
                
            </td>
        </tr>
        </c:forEach>
    </table>
<a href="/travellingsolution/ulogout">logout</a>
</body>
</html>